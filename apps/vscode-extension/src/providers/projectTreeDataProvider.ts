// Contenu final pour: apps/vscode-extension/src/providers/projectTreeDataProvider.ts
import * as vscode from 'vscode';
import { ProjectService, BrickService } from '@jabbarroot/core';
import { JabbarProject, BrickContext } from '@jabbarroot/types';
import { ProjectTreeItem, BrickTreeItem, InfoTreeItem, ProjectViewTreeItem, FileTreeItem, GroupTreeItem } from './projectTreeItem.factory'; 
import { getProjectRootPath } from '../utils/workspace';

export class ProjectTreeDataProvider implements vscode.TreeDataProvider<ProjectViewTreeItem | GroupTreeItem> { 
